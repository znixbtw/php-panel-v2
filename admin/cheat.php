            ...
            <div class="col-xl-4 col-sm-6 col-xs-12 mt-3">
                <div class="card">
                    <div class=" card-body row">
                        ...
                        <div class="col-6">
                            <h4><?= Util::display($cheat->getCheatData()->status); ?></h4>
            ...
            <div class="col-xl-4 col-sm-6 col-xs-12 mt-3">
                <div class="card">
                    <div class=" card-body row">
                        ...
                        <div class="col-6">
                            <h4><?= Util::display($cheat->getCheatData()->version); ?></h4>
            ...
            <div class="col-xl-4 col-sm-6 col-xs-12 mt-3">
                <div class="card">
                    <div class=" card-body row">
                        ...
                        <div class="col-6">
                            <h4><?= Util::display($cheat->getCheatData()->maintenance); ?></h4>
                ...
                <div class="rounded p-3 mb-3">
                    ...
                    <form method="POST" action="<?= Util::display($_SERVER['PHP_SELF']); ?>">
                        <div class="form-row mt-1">
                            <div class="col">
                                <input type="text" class="form-control form-control-sm" placeholder="Version"
                                       name="version" required>
                            </div>

                            <div class="col">
                                <button class="btn btn-outline-primary btn-sm" name="cheatVersion" type="submit"
                                        value="submit">Update
                                </button>
                            </div>
                        </div>
